...
HD_PWD='C:/Users/koola/OneDrive/Desktop/B_RAM/B_RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log B_ram_read.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source B_ram_read.tcl -notrace
