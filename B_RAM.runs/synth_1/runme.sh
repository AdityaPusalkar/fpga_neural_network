...
HD_PWD='C:/Users/koola/OneDrive/Desktop/B_RAM/B_RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log B_ram_read.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source B_ram_read.tcl
